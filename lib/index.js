...
var _isEmpty = _interopRequireDefault(require("ramda/es/isEmpty"));
...
function (_Component) {
  ...
  function WilForm() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_getValid", function () {
      ...
      return (0, _isEmpty.default)(messageErrors);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "_hasValue", function (value) {
      return _typeof(value) === "object" ? !(0, _isEmpty.default)(value) : !!value;
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "_getMessageErrorFocus", function (name, required, value) {
      ...
      if (!!length && required && (value.length <= length.minimum || value.length >= length.maximum)) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_getMessageErrorFieldChange", function (_ref2) {
      ...
      var constraints = _this.state.constraints;
      var _constraints$name3 = constraints[name],
          length = _constraints$name3.length,
          presence = _constraints$name3.presence,
          special = _constraints$name3.special;
  ...
  _createClass(WilForm, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (!(0, _equals.default)(fields, prevState.fields)) {
        this._setState();
      }

      if (!(0, _equals.default)(result, prevState.result)) {
    ...
    value: function render() {
      ...
      return !(0, _isEmpty.default)(fields) && fields.map(this._handleItem);
    }
  }], [{
    key: "getDerivedStateFromProps",
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (!(0, _isEmpty.default)(prevState.fields) && !(0, _equals.default)(nextProps.fields, prevState.fields)) {
        return {
